...
void CG_AdjustPositionForMover( const vec3_t in, int moverNum, int fromTime, int toTime, vec3_t out ) {
	...
	vec3_t	oldAngles, angles/*, deltaAngles*/; // sookee: fix compiler warnings
...
//	VectorSubtract( angles, oldAngles, deltaAngles ); // sookee: fix compiler warnings not currently being used
